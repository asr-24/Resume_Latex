...
\documentclass[11pt, moderncv]{awesome-cv}
...
\geometry{left=1.2cm, top=.5cm, right=1.2cm, bottom=1.0cm, footskip=.5cm}
...
\mobile{+91 91524 11265}
\email{work.arushi1@gmail.com}
%\birth{2002}
%\homepage{http://website.com/}
\github{asr-24}
\linkedin{arushi-rai-cybersecurity}
%\gitlab{gitlab-id}
